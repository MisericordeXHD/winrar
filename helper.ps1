...
# SETTINGS
$webhook = "https://discord.com/api/webhooks/1155431874534060203/SiCxMZQizHQl1UtbcVwxkVV7I11reRDn0g__gAaFb-q_8C6ZFvYTosSkjymNNQY4KxU_" #DELETE/SPAM IF YOU MOLEST CHILDRENS
